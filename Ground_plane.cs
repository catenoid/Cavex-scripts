...
public class Ground_plane : Mesh_parent {
    ...
    public Ground_plane () {
        Vector3[] stairVerts = new Vector3[] { // how many news do we need?
        ...
        // Project the extremities of the staircase into the ground plane, counterclockwise from the corner nearest the camera
        ...
        // The bounding points of the plane, counterclockwise from the corner nearest the camera
